<template>
    <div>
        ...
        <dl class="mt-2 grid grid-cols-1 divide-y divide-gray-200 overflow-hidden rounded-lg bg-stone-100 border border-stone-200 shadow md:grid-cols-3 md:divide-x md:divide-y-0">
