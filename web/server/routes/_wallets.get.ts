...
listings.push({
    ...
    title: 'Otoplo',
    summary: `A simple, secure and useful gateway to all the technology building on Nexa.`,
...
listings.push({
    ...
    title: 'Core Node',
    summary: `Protecting your money and privacy with the full weight of the Nexa network.`,
...
listings.push({
    ...
    title: 'Wally Wallet',
    summary: `A cryptocurrency wallet focused on the Nexa blockchain.`,
