<template>
    <div class="relative isolate overflow-hidden bg-white py-12 sm:py-16">
        <div class="absolute -top-80 left-[max(6rem,33%)] -z-10 transform-gpu blur-3xl sm:left-1/2 md:top-20 lg:ml-20 xl:top-3 xl:ml-56" aria-hidden="true">
            <div
                ...
                style="
                    clip-path: polygon(63.1% 29.6%, 100% 17.2%, 76.7% 3.1%, 48.4% 0.1%, 44.6% 4.8%, 54.5% 25.4%, 59.8% 49.1%, 55.3% 57.9%, 44.5% 57.3%, 27.8% 48%, 35.1% 81.6%, 0% 97.8%, 39.3% 100%, 35.3% 81.5%, 97.2% 52.8%, 63.1% 29.6%);
                "
            />
        </div>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:mx-0">
                ...
                <h1 class="mt-2 text-pretty text-7xl font-light italic tracking-tight text-teal-500 sm:text-8xl uppercase">
                    {{term}}
                </h1>
                ...
                <div class="relative lg:order-last lg:col-span-5">
                    ...
                    <figure class="border-l border-indigo-600 pl-8">
                        ...
                        <figcaption class="mt-8 flex gap-x-4">
                            ...
                            />
                            <div class="text-sm/6">
                                <div class="font-semibold text-gray-900">Ava Nakamoto</div>
                                <div class="text-gray-600">@anakamoto</div>
                            </div>
                        </figcaption>
                    </figure>
                </div>
                <div class="max-w-xl text-base/7 text-gray-700 lg:col-span-7">
                    ...
                    <ul role="list" class="mt-8 max-w-xl space-y-8 text-gray-600">
                        <li class="flex gap-x-3">
                            <CloudArrowUpIcon class="mt-1 size-5 flex-none text-sky-600" aria-hidden="true" />
                            <span>
                                <strong class="font-semibold text-gray-900">For Everyday People.</strong>
                        ...
                        <li class="flex gap-x-3">
                            <LockClosedIcon class="mt-1 size-5 flex-none text-sky-600" aria-hidden="true" />
                            <span><strong class="font-semibold text-gray-900">For Contributors.</strong>
                                Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo.</span>
                        </li>

                        <li class="flex gap-x-3">
                            <ServerIcon class="mt-1 size-5 flex-none text-sky-600" aria-hidden="true" />
                            <span><strong class="font-semibold text-gray-900">For Investors.</strong>
                                Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.</span>
                        </li>

                        <li class="flex gap-x-3">
                            <ServerIcon class="mt-1 size-5 flex-none text-sky-600" aria-hidden="true" />
                            <span><strong class="font-semibold text-gray-900">For Haters.</strong>
                                Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.</span>
                        </li>
                    </ul>
...
const term = ref(path.value.slice(8))
...
onMounted(() => {
    ...
    console.log('TERM is', term.value)
